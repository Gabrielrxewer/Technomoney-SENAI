...
const parHandler: RequestHandler = async (req, res) => {
  const p = req.body || {};
...
const authorizeHandler: RequestHandler = async (req: any, res: Response) => {
...
const tokenHandler: RequestHandler = async (req: Request, res: Response) => {
...
const userinfoHandler: RequestHandler = async (req: Request, res: Response) => {
